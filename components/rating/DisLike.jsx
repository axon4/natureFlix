...
function DisLike({ filled, onClick }) {
	return (
		<div className={styles.wrapper}>
			<button onClick={onClick}>
				<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='34px' height='34px' fill='white'>
					<path d='M3 12v2h9l-1.34 5.34L15 15V5H6z' opacity={filled ? 1 : 0} />
